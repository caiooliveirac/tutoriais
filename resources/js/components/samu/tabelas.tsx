...
/** Colunas e layout de cada tabela de ocorrências (mesmas do mock). */
export type Tabela = { titulo: string; colunas: Coluna[]; grid: string };
...
export const tabelas: Record<string, Tabela> = {
    chamados: {
